...
public class LivroTest extends IntegrationTestConfiguration {
    ...
    private void prepararDados() {
        ...
        this.livro2 = new Livro("Clean Code", LocalDate.of(2018, 1, 1), editora2, generoLiterario2, "123456789112", autor2);
    ...
    public void findByPage_QuandoParametroTitulo_Retornando200OK() {
        givenAuthenticated()
                ...
                .body("content[0].titulo", is("Clean Code"))
    ...
    public void findByPage_QuandoParametroEditora_Retornando200OK() {
        givenAuthenticated()
                ...
                .body("content[1].titulo", is("Clean Code"))
