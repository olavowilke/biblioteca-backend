package br.com.biblioteca.config.token;
...
import static br.com.biblioteca.config.AuthorizationServerConfig.REFRESH_TOKEN_VALIDITY_SECONDS;
...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
    ...
    @Override
    public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken oAuth2AccessToken, MethodParameter returnType,
